package com.quyettienbn.book_store.socket.app.test;
...
import com.quyettienbn.book_store.socket.app.AppEntryLoader;
import com.quyettienbn.book_store.socket.plugin.PluginEntryLoader;
        ...
        public EzyPluginEntry load() {
            return new PluginEntry() {
                ...
                protected String[] getScanablePackages() {
                    return new String[] { "com.quyettienbn.book_store" };
                }
            };
        }
    }
